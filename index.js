...
function displayResults(responseJson) {
  $("#results-list").append(
    `<li><p>Positive Test Results:</p>${responseJson.positive}<p>Total number of poeple with confirmed or probable cases of Covid-19. A confirmed case has a positive test result, a probably case is when a patient has symptoms and has been exposed to a confirmed case.</li>
        <li><p>Negative Test Results:</p>${responseJson.negative}<p>Results of the PCR (molecular) test the have returned negative. This number should be considered an estimate because of the complexity of reporting it.</li>
  ...
  //     var num = displayResults(responseJson);
